			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="updatedBy-label" class="property-label"><g:message code="user.updatedBy.label" default="Updated By" /></span>
						...
						<span class="property-value" aria-labelledby="updatedBy-label"><g:fieldValue bean="${userInstance}" field="updatedBy"/></span>
				...
				<g:if test="${role?.authority}">
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="role.authority.label" default="Authority" /></span>
					
						<span class="property-value" aria-labelledby="authority-label"><g:fieldValue bean="${role}" field="authority"/></span>
